...
(function (e) {
    ...
    t.o = function () {
        ...
        this.run = function () {
            ...
            this.$c = e(document.createElement("canvas")).attr({width: this.o.width+5, height: this.o.height+9});
        ...
        this._carve = function () {
            ...
            this.$c.attr({width: this.w+2, height: this.h+2});
            if (this.scale !== 1) {
                this.$c[0].width = this.$c[0].width * this.scale+2;
                this.$c[0].height = this.$c[0].height * this.scale+2;
                this.$c.width(this.w);
